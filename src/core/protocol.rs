...
impl ProtocolId {
    ...
    pub fn peer(&self) -> ProtocolId {
        match *self {
            ProtocolId::Pair       => ProtocolId::Pair,
            ProtocolId::Pub        => ProtocolId::Sub,
            ProtocolId::Sub        => ProtocolId::Pub,
            ProtocolId::Req        => ProtocolId::Rep,
            ProtocolId::Rep        => ProtocolId::Req,
            ProtocolId::Push       => ProtocolId::Pull,
            ProtocolId::Pull       => ProtocolId::Push,
            ProtocolId::Surveyor   => ProtocolId::Respondent,
            ProtocolId::Respondent => ProtocolId::Surveyor,
            ProtocolId::Bus        => ProtocolId::Bus,
        }
    }

    pub fn matches(&self, other: ProtocolId) -> bool {
...
mod tests {
    ...
    #[test]
    fn can_cast_protocol_id_to_u16() {
        let pid = ProtocolId::Pair;
        let id = pid as u16;
